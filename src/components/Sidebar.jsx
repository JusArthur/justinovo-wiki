...
const Sidebar = ({ lang }) => {
  ...
  const navItems = [
    ...
    },
    {
      ...
      icon: ( <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 28 28" className="h-7 w-7"><circle cx="14" cy="14" r="10" stroke="currentColor" strokeWidth="1.6"/><path stroke="currentColor" strokeLinecap="round" strokeWidth="1.5" d="M10 18c2.5 2.5 5.5 2.5 8 0"/></svg> )
    },
    {
