  ...
  return (
    ...
    <main className="max-w-[1100px] mx-auto min-h-screen p-8 flex flex-nowrap justify-center items-center gap-6 relative overflow-x-auto">
      ...
      <div className="w-[400px] min-w-[400px] flex flex-col items-center relative z-20">
        ...
        {/* Top Photo Collage */}
        <div className={`glass-card w-90 h-[190px] p-3 bg-white/30 border-white mb-10 ${getRevealClass(2, 'up')}`}>
        ...
        <div className="mt-8 flex justify-between items-start w-[520px] ml-30 relative z-30">
          ...
          <div className={`relative flex flex-col items-start mt-2 pl-10 pb-18 ${getRevealClass(5, 'right')}`}>
            <article className="glass-card p-2 pr-4 w-[275px] rounded-full flex items-center gap-3">
              ...
              <button
                className="w-9 h-9 rounded-full bg-white flex items-center justify-center text-[#35bfab] shadow-sm ml-1 shrink-0"
            ...
            {/* Draggable Like Button (defaults below the music player) */}
            <div
            ...
            >
              <span className="text-pink-400 text-xl pointer-events-none">♥</span>
              <span className="absolute -top-2 -right-4 bg-white/80 backdrop-blur-md text-gray-500 text-[10px] px-1.5 py-0.5 rounded-full border border-white pointer-events-none">15690</span>
            </div>
          </div>
